...
class TestProductModel(unittest.TestCase):
    ...
    def test_create_a_product(self):
        ...
        product = Product(name="Fedora", description="A red hat", price=12.50, available=True, category=1)
        ...
        self.assertEqual(product.category, 1)
    ...
    def test_deserialize_missing_name(self):
        """Test deserializing with missing 'name' field"""
        product = ProductFactory()
        product.id = None
        product.create()
        data = {
            ...
            "price": "10.99",
            "available": True,
            "category": 1  # convert enum to string
        }
        with self.assertRaises(DataValidationError) as context:
    ...
    def test_deserialize_invalid_boolean(self):
        """
        Test deserializing with invalid boolean type for 'available' field
        """
        product = ProductFactory()
        product.id = None
        product.create()
    ...
    def test_deserialize_invalid_category(self):
        """
        Test deserializing with invalid 'category' field
        """
        product = ProductFactory()
        product.id = None
        product.create()
    ...
    def test_deserialize_missing_field(self):
        """
        Test deserializing with a missing required field
        """
    ...
    def test_deserialize_invalid_price_type(self):
        """
        Test deserializing with invalid type for 'price' field
        """
        ...
        data = {
            "name": "Test Product",
            "description": "A product description",
            "price": 10.99,  # should be a string
            "available": True,
            "category": 1
        }
